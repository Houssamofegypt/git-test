...
TESTS = [
 ...
 ("productivity", "The 14 letters are unusually productive — they compose more Quranic words than a random 14 would",
  "1,504 word-forms (29.5% of all occurrences) vs 1,598 expected for frequency-matched subsets", 0.6236, "NOT supported",
  "The methodological centrepiece of the study. Against UNIFORM random 14-letter subsets the result is p=0.010 and looks like a discovery. Against subsets matched on total corpus frequency it is p=0.62, and slightly BELOW expectation. The apparent productivity is entirely explained by the letters being common ones."),
 ("mechanism", "The enrichment tracks some structural property of the surah",
  "no correlation with verse length, word length, segments per word, surah size, opening length or period", 0.5333, "NOT supported",
  "Best of six correlations reported. The enrichment is real and stable but remains unexplained by anything tested."),
